...
_0x0:
	...
	.DB  0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20
	.DB  0x0,0x43,0x45,0x3A,0x20,0x46,0x55,0x4C
	.DB  0x4C,0x0,0x25,0x64,0x0,0x43,0x45,0x3A
	.DB  0x20,0x0,0x43,0x45,0x3A,0x20,0x31,0x30
	.DB  0x30,0x30,0x0,0x30,0x30,0x3A,0x30,0x30
	.DB  0x3A,0x30,0x30,0x3A,0x30,0x30,0x0
_0x20000:
	.DB  0x30,0x30,0x3A,0x30,0x30,0x3A,0x30,0x30
	.DB  0x3A,0x30,0x30,0x0,0x43,0x45,0x3A,0x20
	.DB  0x31,0x30,0x30,0x30,0x0,0x25,0x64,0x0
	.DB  0x3A,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0027     char *temp = " ";
; 0000 0028 
; 0000 0029     if (PINB.2 == 0){ //CAR_IN
	ST   -Y,R17
	ST   -Y,R16
;	*temp -> R16,R17
	__POINTWRMN 16,17,_0x5,0
	SBIC 0x16,2
	RJMP _0x6
; 0000 002A         CE--;
	LDI  R26,LOW(_CE)
...
; 0000 002C             lcd_gotoxy(0,1);
	CALL SUBOPT_0x2
; 0000 002D             lcd_puts(space);
	CALL SUBOPT_0x3
; 0000 002E             lcd_gotoxy(0,1);
; 0000 002F             lcd_puts("CE: FULL");
	__POINTW2MN _0x5,2
	RJMP _0x14
; 0000 0030         }
; 0000 0031         else{
_0x7:
; 0000 0032             sprintf(temp,"%d",CE);
	CALL SUBOPT_0x4
; 0000 0033             lcd_gotoxy(0,1);
; 0000 0034             lcd_puts(space);
	CALL SUBOPT_0x3
; 0000 0035             lcd_gotoxy(0,1);
; 0000 0036             lcd_puts("CE: ");
	__POINTW2MN _0x5,11
	CALL _lcd_puts
; 0000 0037             lcd_puts(temp);
	MOVW R26,R16
_0x14:
	CALL _lcd_puts
; 0000 0038         }
; 0000 0039     }
; 0000 003A     if (PINB.3 == 0){ //CAR_OUT
_0x6:
	SBIC 0x16,3
	RJMP _0x9
; 0000 003B         if (CE == 1000){
	LDS  R26,_CE
	LDS  R27,_CE+1
	CPI  R26,LOW(0x3E8)
	LDI  R30,HIGH(0x3E8)
...
; 0000 003C             lcd_gotoxy(0,1);
	CALL SUBOPT_0x2
; 0000 003D             lcd_puts(space);
	CALL SUBOPT_0x3
; 0000 003E             lcd_gotoxy(0,1);
; 0000 003F             lcd_puts("CE: 1000");
	__POINTW2MN _0x5,16
	RJMP _0x15
; 0000 0040         }
; 0000 0041         else {
...
; 0000 0042             CE++;
	...
	LDI  R27,HIGH(_CE)
	CALL SUBOPT_0x5
; 0000 0043             sprintf(temp,"%d",CE);
	CALL SUBOPT_0x4
; 0000 0044             lcd_gotoxy(0,1);
; 0000 0045             lcd_puts(space);
	CALL SUBOPT_0x3
; 0000 0046             lcd_gotoxy(0,1);
; 0000 0047             lcd_puts("CE: ");
	__POINTW2MN _0x5,25
	CALL _lcd_puts
; 0000 0048             lcd_puts(temp);
	MOVW R26,R16
_0x15:
	CALL _lcd_puts
; 0000 0049             }
...
; .FSTART _ext_int1_isr
	CALL SUBOPT_0x0
; 0000 0051     if (PINB.4 == 0){ //START is ON
	SBIC 0x16,4
	RJMP _0xC
; 0000 0052         lcd_gotoxy(0,0);
	CALL SUBOPT_0x6
; 0000 0053         lcd_puts(space);
	CALL SUBOPT_0x7
...
; 0000 0056         STOP = 1;
	CALL SUBOPT_0x8
; 0000 0057     }
; 0000 0058     if (PINB.5 == 0 && STOP == 10){ //STOP is ON
_0xC:
	SBIC 0x16,5
	RJMP _0xE
	LDS  R26,_STOP
...
; 0000 005A         lcd_gotoxy(0,0);
	CALL SUBOPT_0x6
; 0000 005B         lcd_puts(space);
	CALL SUBOPT_0x7
; 0000 005C         lcd_gotoxy(0,0);
; 0000 005D         lcd_puts("00:00:00:00");
	__POINTW2MN _0x10,0
	CALL _lcd_puts
; 0000 005E         lcd_gotoxy(0,0);
	CALL SUBOPT_0x6
; 0000 005F         lcd_puts(space);
	CALL SUBOPT_0x7
; 0000 0060         lcd_gotoxy(0,0);
; 0000 0061         lcd_puts("00:00:00:00");
...
; 0000 0066         CNT4 = 0;
; 0000 0067     }
; 0000 0068     else if (PINB.5 == 0){ //STOP is ON
	RJMP _0x11
_0xD:
	SBIC 0x16,5
	RJMP _0x12
; 0000 0069         STOP = 10; //means stop is on
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	STS  _STOP,R30
	STS  _STOP+1,R31
...
; 0000 0080 
; 0000 0081 
; 0000 0082     //question_01();
; 0000 0083     //question_02();
; 0000 0084     question_03();
	RCALL _question_03
; 0000 0085 }
_0x13:
	RJMP _0x13
...
; 0001 00A1         CNT4++;
	SBIW R28,2
	LDI  R30,LOW(_0x20004+9)
	LDI  R31,HIGH(_0x20004+9)
	ST   Y,R30
	STD  Y+1,R31
	CALL __SAVELOCR6
;	*firstNum -> R16,R17
...
;	*fourthNum -> Y+6
	...
	__POINTWRMN 18,19,_0x20004,3
	__POINTWRMN 20,21,_0x20004,6
	LDI  R26,LOW(_CNT4)
	LDI  R27,HIGH(_CNT4)
	CALL SUBOPT_0x5
; 0001 00A2 
...
; 0001 00B9         lcd_puts(firstNum);
	...
	RCALL _lcd_puts
; 0001 00BA         lcd_puts(":");
	__POINTW2MN _0x20004,12
	RCALL _lcd_puts
; 0001 00BB         lcd_puts(secondNum);
	MOVW R26,R18
	RCALL _lcd_puts
; 0001 00BC         lcd_puts(":");
	__POINTW2MN _0x20004,14
	RCALL _lcd_puts
; 0001 00BD         lcd_puts(thirdNum);
	MOVW R26,R20
	RCALL _lcd_puts
; 0001 00BE         lcd_puts(":");
	__POINTW2MN _0x20004,16
	RCALL _lcd_puts
