...
_ds:
	.DB  0x80,0x0,0x40,0x0,0xFF,0xFF,0xFF,0xFF
	...
	.DB  0x1F,0xF,0x7,0x7,0x23,0x11,0x0,0x0
	.DB  0x0,0x0,0x1,0x83,0x87,0xF,0x1F,0x1F
	.DB  0x3F,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	...
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFC,0xF8,0xF0,0xE0,0xE0,0xC0,0x80,0x80
	.DB  0x0,0x0,0x68,0x4D,0x0,0x80,0xC0,0xC0
	.DB  0xE0,0xE0,0xF0,0xFB,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
	.DB  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF
...
_AR16x8:
	.DB  0x0,0x0,0xFC,0x0,0xFE,0x0,0x13,0x0
	.DB  0x13,0x0,0x13,0x0,0xFE,0x0,0xFC,0x0
	.DB  0x0,0x0,0xFF,0x0,0xFF,0x0,0x39,0x0
	.DB  0x69,0x0,0xCF,0x0,0x86,0x0,0x0,0x0
	.DB  0xFC,0x0,0xFE,0x0,0x13,0x0,0x13,0x0
	.DB  0x13,0x0,0xFE,0x0,0xFC,0x0,0x0,0x0
	.DB  0xFF,0x0,0xFF,0x0,0x39,0x0,0x69,0x0
	.DB  0xCF,0x0,0x86,0x0,0x0,0x0,0x0,0x0
	.DB  0xFE,0x0,0x13,0x0,0x13,0x0,0x13,0x0
	.DB  0xFE,0x0,0xFC,0x0,0x0,0x0,0xFF,0x0
	.DB  0xFF,0x0,0x39,0x0,0x69,0x0,0xCF,0x0
	.DB  0x86,0x0,0x0,0x0,0x0,0x0,0xFC,0x0
	.DB  0x13,0x0,0x13,0x0,0x13,0x0,0xFE,0x0
	.DB  0xFC,0x0,0x0,0x0,0xFF,0x0,0xFF,0x0
	.DB  0x39,0x0,0x69,0x0,0xCF,0x0,0x86,0x0
	.DB  0x0,0x0,0x0,0x0,0xFC,0x0,0xFE,0x0
	.DB  0x13,0x0,0x13,0x0,0xFE,0x0,0xFC,0x0
	.DB  0x0,0x0,0xFF,0x0,0xFF,0x0,0x39,0x0
	.DB  0x69,0x0,0xCF,0x0,0x86,0x0,0x0,0x0
	.DB  0x0,0x0,0xFC,0x0,0xFE,0x0,0x13,0x0
...
; 0001 0014     DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
...
; 0001 0028          while (1){
_0x20006:
; 0001 0029             PORTD = 0x80;
	LDI  R30,LOW(128)
	OUT  0x12,R30
; 0001 002A             PORTB = ~AR16x8[i];
	LDS  R30,_i
	LDS  R31,_i+1
	LDI  R26,LOW(_AR16x8*2)
	LDI  R27,HIGH(_AR16x8*2)
	LSL  R30
	ROL  R31
	ADD  R30,R26
	ADC  R31,R27
...
; 0001 002F             PORTD = 0x00;
	LDI  R30,LOW(0)
	OUT  0x12,R30
; 0001 0030             PORTB = ~AR16x8[i+8];
	LDS  R30,_i
	LDS  R31,_i+1
	LSL  R30
	ROL  R31
	__ADDW1FN _AR16x8,16
	CALL SUBOPT_0x2
; 0001 0031             PORTA = 1<<j;
; 0001 0032 
; 0001 0033             i++;
...
;
;void Question_02(){
; 0001 008A void Question_02(){
_Question_02:
; .FSTART _Question_02
; 0001 008B     glcd_putimagef(0,0,ds,GLCD_PUTCOPY);
	LDI  R30,LOW(0)
	ST   -Y,R30
	ST   -Y,R30
	LDI  R30,LOW(_ds*2)
...
; 0001 00A0         }
; 0001 00A1 
; 0001 00A2         glcd_clear();
_0x20020:
	RCALL _glcd_clear
; 0001 00A3 
; 0001 00A4         glcd_circle(63, 31, 30);
	CALL SUBOPT_0x6
	LDI  R26,LOW(30)
	CALL _glcd_circle
; 0001 00A5         glcd_setlinestyle(3,4);
	LDI  R30,LOW(3)
	__PUTB1MN _glcd_state,8
	LDI  R30,LOW(4)
	__PUTB1MN _glcd_state,9
; 0001 00A6         glcd_circle(63, 31, 2);
	CALL SUBOPT_0x6
	LDI  R26,LOW(2)
	CALL _glcd_circle
; 0001 00A7         glcd_setlinestyle(1,GLCD_LINE_SOLID);
	CALL SUBOPT_0x7
; 0001 00A8 
; 0001 00A9         x = 25*cos(second*6);
	CALL SUBOPT_0x8
	CALL _cos
	CALL SUBOPT_0x9
	CALL SUBOPT_0xA
; 0001 00AA         y = 25*sin(second*6);
	CALL SUBOPT_0x8
	CALL _sin
	CALL SUBOPT_0x9
	CALL SUBOPT_0xB
; 0001 00AB 
; 0001 00AC         glcd_line(63,31,x+63,31-y);
	CALL SUBOPT_0xC
; 0001 00AD 
; 0001 00AE         x = 20*cos(minute*6);
	CALL SUBOPT_0xD
	CALL _cos
	CALL SUBOPT_0xE
	CALL SUBOPT_0xA
; 0001 00AF         y = 20*sin(minute*6);
	CALL SUBOPT_0xD
	CALL _sin
	CALL SUBOPT_0xE
	CALL SUBOPT_0xB
; 0001 00B0 
; 0001 00B1         glcd_line(63,31,x+63,31-y);
	CALL SUBOPT_0xC
; 0001 00B2 
; 0001 00B3         x = 15*cos(hour*6);
	CALL SUBOPT_0xF
	CALL _cos
	CALL SUBOPT_0x10
	CALL SUBOPT_0xA
; 0001 00B4         y = 15*sin(hour*6);
	CALL SUBOPT_0xF
	CALL _sin
	CALL SUBOPT_0x10
	CALL SUBOPT_0xB
; 0001 00B5 
; 0001 00B6         glcd_line(63,31,x+63,31-y);
	CALL SUBOPT_0xC
; 0001 00B7 }
	RET
; .FEND
...
;
;void TimerInit(){
; 0001 00BA void TimerInit(){
_TimerInit:
; .FSTART _TimerInit
; 0001 00BB 
; 0001 00BC 
; 0001 00BD     // Timer/Counter 1 initialization
; 0001 00BE     // Clock source: System Clock
; 0001 00BF     // Clock value: 31.250 kHz
; 0001 00C0     // Mode: Normal top=0xFFFF
; 0001 00C1     // OC1A output: Disconnected
; 0001 00C2     // OC1B output: Disconnected
; 0001 00C3     // Noise Canceler: Off
; 0001 00C4     // Input Capture on Falling Edge
; 0001 00C5     // Timer Period: 1 s
; 0001 00C6     // Timer1 Overflow Interrupt: On
; 0001 00C7     // Input Capture Interrupt: Off
; 0001 00C8     // Compare A Match Interrupt: Off
; 0001 00C9     // Compare B Match Interrupt: Off
; 0001 00CA     TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	LDI  R30,LOW(0)
	OUT  0x2F,R30
; 0001 00CB     TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (1<<CS12) | (0<<CS11) | (0<<CS10);
	LDI  R30,LOW(4)
	OUT  0x2E,R30
; 0001 00CC     TCNT1H=0x85;
	LDI  R30,LOW(133)
	OUT  0x2D,R30
; 0001 00CD     TCNT1L=0xEE;
	LDI  R30,LOW(238)
	OUT  0x2C,R30
; 0001 00CE     ICR1H=0x00;
	LDI  R30,LOW(0)
	OUT  0x27,R30
; 0001 00CF     ICR1L=0x00;
	OUT  0x26,R30
; 0001 00D0     OCR1AH=0x00;
	OUT  0x2B,R30
; 0001 00D1     OCR1AL=0x00;
	OUT  0x2A,R30
; 0001 00D2     OCR1BH=0x00;
	OUT  0x29,R30
; 0001 00D3     OCR1BL=0x00;
	OUT  0x28,R30
; 0001 00D4 
; 0001 00D5     // Timer(s)/Counter(s) Interrupt(s) initialization
; 0001 00D6     TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (1<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(4)
	OUT  0x39,R30
; 0001 00D7 
; 0001 00D8 
...
;Imported image file name: ds.bmp
;
...
;0x02, 0xFC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
;0x23, 0x11, 0x00, 0x00, 0x00, 0x00, 0x01, 0x83,
;0x87, 0x0F, 0x1F, 0x1F, 0x3F, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
...
;0xE0, 0xC0, 0x80, 0x80, 0x00, 0x00, 0x68, 0x4D,
;0x00, 0x80, 0xC0, 0xC0, 0xE0, 0xE0, 0xF0, 0xFB,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
;0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
